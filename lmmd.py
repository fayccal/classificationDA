...
# Local Maximum Mean Discrepancy (LMMD) Loss for Domain Adaptation
class LMMD_loss(nn.Module):
    ...
    #Calculer la matrice du kernel Gaussien entre les données source et cible
    ...
    # retourne la perte calculer entre le domain source et le domain cible
    ...
    # OneHot encoding pour des labels scalar
    def convert_to_onehot(self, sca_label, class_num=31):
        return np.eye(class_num)[sca_label]

    #calcule des poids entre le domain source et cible
